...
const LoginPage = () => {
  ...
  return <>
      <Helmet>
        <title>Login - Escala Barueri</title>
      </Helmet>
        ...
        ease: 'easeOut'
          ...
          <div className="w-1/3 bg-barueri-black p-8 flex-col items-center justify-center text-center hidden md:flex">
            ...
            delay: 0.2
              ...
              <p className="text-4xl font-bold text-white">Semurb
            </p>
            </motion.div>
          </div>
          <div className="w-full md:w-2/3 bg-white p-12 flex flex-col justify-center">
            ...
            <form onSubmit={handleLogin} className="space-y-6">
              ...
              <div className="relative">
                ...
                <input type={showPassword ? 'text' : 'password'} className="w-full p-3 border-b-2 border-gray-300 focus:border-barueri-yellow focus:outline-none transition" />
